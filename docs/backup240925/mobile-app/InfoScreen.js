  ...
  const renderContent = (section) => {
   ...
   return (
     <View style={{
       ...
       <DynamicHamburgerMenu onNavigate={onNavigate} isLoggedIn={false} />
       
       {/* Header-Bild (Info-Button-Bild) */}
       <OptimizedImage source={require('./assets/images-optimized/info-bg.jpg')}
         style={{
           width: '100%',
           height: 200,
