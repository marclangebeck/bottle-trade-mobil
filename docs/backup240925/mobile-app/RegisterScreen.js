...
import { registerUser } from './services/authService-web';

export default function RegisterScreen({ onRegister, onShowLogin }) {
      ...
      setProfileImage(result.assets[0].uri);
         ...
         return (
           <View style={{
             ...
             {/* Header-Bild (Register-Button-Bild) */}
             <OptimizedImage source={require('./assets/images-optimized/register-bg.jpg')}
               style={{
                 width: '100%',
                 height: 200,
