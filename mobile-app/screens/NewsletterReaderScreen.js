...
export default function NewsletterReaderScreen({ onNavigate, onLogout, newsletter: newsletterProp, onMarkNewsletterAsRead, newsletterId, isLoggedIn = false, unreadCount = 0 }, isPro = false) {
