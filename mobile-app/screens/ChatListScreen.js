...
export default function ChatListScreen({ onNavigate, onLogout, chats = [], unreadCount = 0, onMarkChatAsRead, onMarkAllChatsAsRead = null, onDeleteChat = null, notifications = [], isLoggedIn = false, onDeclineTradeRequest = null, onMarkAllChatNotificationsAsRead = null, isPro = false }) {
